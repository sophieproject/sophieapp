...
public class srfi69 extends ModuleBody {
                ...
                try {
                    ...
                    while (arg0 != LList.Empty) {
                        try {
                            ...
                            hashTableUpdate$Ex$SlDefault(hash$Mntable, C0621lists.car.apply1(elem), lambda$Fn1, C0621lists.cdr.apply1(elem));
                            arg0 = arg02.getCdr();
    ...
    public static hashtable.HashTable alist$To$HashTable(Object obj, Object obj2, Object obj3) {
        ...
        objArr[0] = Lit0;
        try {
            objArr[1] = Integer.valueOf(C0621lists.length((LList) obj) * 2);
    ...
    static Pair lambda2(Object key, Object val, Object acc) {
        return C0621lists.cons(key, acc);
    }
    ...
    static Pair lambda3(Object key, Object val, Object acc) {
        return C0621lists.cons(val, acc);
    }
