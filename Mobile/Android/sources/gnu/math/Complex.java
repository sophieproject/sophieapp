...
public abstract class Complex extends Quantity {
    ...
    public boolean isExact() {
        return mo10981re().isExact() && mo10980im().isExact();
    }

    /* Debug info: failed to restart local var, previous not found, register: 4 */
    public Complex toExact() {
        RealNum re = mo10981re();
        RealNum im = mo10980im();
    ...
    public Complex toInexact() {
        return isExact() ? this : new DComplex(mo10981re().doubleValue(), mo10980im().doubleValue());
    }
    ...
    public double doubleValue() {
        return mo10981re().doubleValue();
    }

    public double doubleImagValue() {
        return mo10980im().doubleValue();
    }
    ...
    public static boolean equals(Complex x, Complex y) {
        return x.mo10981re().equals(y.mo10981re()) && x.mo10980im().equals(x.mo10980im());
    }
    ...
    public static int compare(Complex x, Complex y) {
        int code = x.mo10980im().compare(y.mo10980im());
        return code != 0 ? code : x.mo10981re().compare(y.mo10981re());
    }
    ...
    public boolean isZero() {
        return mo10981re().isZero() && mo10980im().isZero();
    }

    public String toString(int radix) {
        if (mo10980im().isZero()) {
            return mo10981re().toString(radix);
        }
        String imString = mo10980im().toString(radix) + "i";
        if (imString.charAt(0) != '-') {
            imString = "+" + imString;
        }
        return !mo10981re().isZero() ? mo10981re().toString(radix) + imString : imString;
    }

    public static Complex neg(Complex x) {
        return make(x.mo10981re().rneg(), x.mo10980im().rneg());
    }
    ...
    public static Complex add(Complex x, Complex y, int k) {
        return make(RealNum.add(x.mo10981re(), y.mo10981re(), k), RealNum.add(x.mo10980im(), y.mo10980im(), k));
    }
    ...
    public static Complex times(Complex x, Complex y) {
        RealNum x_re = x.mo10981re();
        RealNum x_im = x.mo10980im();
        RealNum y_re = y.mo10981re();
        RealNum y_im = y.mo10980im();
