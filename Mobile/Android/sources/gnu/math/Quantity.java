...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo10981re() {
        return number().mo10981re();
    }

    /* renamed from: im */
    public RealNum mo10980im() {
        return number().mo10980im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo10981re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo10980im().doubleValue();
    }
