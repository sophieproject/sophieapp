...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    @SimpleProperty
    /* renamed from: Y */
    public void mo7362Y(double y) {
        updateY(y);
        registerChange();
    }

    /* renamed from: Y */
    public double mo5817Y() {
    ...
    @SimpleProperty
    /* renamed from: Z */
    public void mo7364Z(double layer) {
        this.zLayer = layer;
